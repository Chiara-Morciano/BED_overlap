...
#SBATCH -o /gpfs/home/uqn25mpu/scratch/BED_overlap/Output_Messages/%x-%j.out   # TODO: set your path
#SBATCH -e /gpfs/home/uqn25mpu/scratch/BED_overlap/Error_Messages/%x-%j.err    # TODO: set your path
#SBATCH --mail-type=END,FAIL
#SBATCH --mail-user=uqn25mpu@uea.ac.uk  # TODO: set to your UEA email 
# --- Modules ---
module load bedtools

# --- Inputs (TODO: update to your paths from Step 1) ---
file1="/gpfs/home/uqn25mpu/scratch/BED_overlap/DPure_indels_mask.bed"
file2="/gpfs/home/uqn25mpu/scratch/BED_overlap/LPure_indels_mask.bed"

# --- Outputs (TODO: ensure this exists) ---
output_dir="/gpfs/home/uqn25mpu/scratch/BED_overlap/output"
mkdir -p "$output_dir"
